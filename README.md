...
- Email workflows powered by SendGrid dynamic templates
...
- Stripe and SendGrid accounts with API credentials
...
| `ACTIVATE_EMAIL_ID`        | SendGrid dynamic template id for account activation                     |
| `PASSWORD_RESET_ID`        | SendGrid dynamic template id for password resets                        |
| `RECEIPT_EMAIL_ID`         | SendGrid dynamic template id for receipts                               |
